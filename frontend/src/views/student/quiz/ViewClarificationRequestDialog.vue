<template>
  ...
  >
    <v-card>
      <v-card-title>
        <span class="headline">Discussion</span>
      </v-card-title>
        ...
        <v-container grid-list-md fluid>
          <v-layout column wrap>
            ...
            <div v-if="!!clarification">
              ...
              <v-flex xs24 sm12 md8>
                <p>{{ clarificationRequest.clarification.text }}</p>
              </v-flex>

              <v-divider></v-divider>

              <comment-view v-model="CommentView" :clarificationRequest="clarificationRequest" />
              ...
              <div v-if="clarification.summary != null">
                ...
                <v-flex xs24 sm12 md8>{{ clarificationRequest.clarification.summary }}</v-flex>
              </div>
            </div>
          </v-layout>
        </v-container>
