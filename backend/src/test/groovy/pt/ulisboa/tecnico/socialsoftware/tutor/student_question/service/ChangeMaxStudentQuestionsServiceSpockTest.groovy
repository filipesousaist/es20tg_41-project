...
@DataJpaTest
class ChangeMaxStudentQuestionsServiceSpockTest extends Specification {
    ...
    def "set max student questions to 2 and create 3 questions"() {
        ...
        when:
        studentQuestionService.changeMaxStudentQuestions(user, 2)
        studentQuestionService.createStudentQuestion(course.getId(), userId, studentQuestionDto)
        studentQuestionService.createStudentQuestion(course.getId(), userId, studentQuestionDto)
        studentQuestionService.createStudentQuestion(course.getId(), userId, studentQuestionDto)

        then:
        studentQuestionRepository.findAll().size() == 2
    }
